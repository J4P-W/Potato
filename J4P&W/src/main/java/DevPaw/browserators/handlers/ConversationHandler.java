...
public class ConversationHandler {
	...
	public ConversationHandler(MessageHandler mh,int messageid, DevClient dc) throws FailingHttpStatusCodeException, MalformedURLException, IOException, ParseException {
